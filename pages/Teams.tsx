            ...
            >
              ...
              <div className="flex gap-3 pt-2 border-t light:border-gray-200 dark:border-white/10 mt-6">
                <button
                  ...
                  className="flex-1 px-5 py-3 light:bg-gray-50 dark:bg-white/5 light:border-gray-200 dark:border-white/10 rounded-xl light:text-gray-900 dark:text-white light:hover:bg-gray-100 dark:hover:bg-white/[0.08] transition-all font-light"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="flex-1 px-5 py-3 bg-gradient-to-r from-[#1e3a5f] to-[#1e5a8d] hover:from-[#1e4976] hover:to-[#2563eb] text-white font-medium rounded-xl transition-all shadow-lg shadow-[#1e3a5f]/25 hover:shadow-[#1e5a8d]/40 hover:scale-[1.02]"
                >
                  Criar Equipe
                </button>
              </div>
