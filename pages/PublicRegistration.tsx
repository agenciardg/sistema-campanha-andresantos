          ...
          <div className="bg-gradient-to-br from-[#15202b] to-[#192633] rounded-2xl border border-[#324d67] max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col shadow-2xl animate-slideUp">
            ...
            <div className="p-6 overflow-y-auto text-[#92adc9] space-y-4 text-sm custom-scrollbar">
              ...
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-white mb-2">André Santos</h2>
              ...
              <p>
                Esta Política de Privacidade estabelece como André Santos coleta, usa, armazena e protege os dados pessoais dos usuários que se cadastram em nossa plataforma digital.
              </p>
              <p>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Envio de conteúdos informativos sobre as atividades de André Santos</li>
              ...
              <p>Enviar solicitação para: <strong className="text-[#1e5a8d]">contato@andresantosoficial.com.br</strong></p>
              ...
              <p className="mt-2"><strong>Email:</strong> contato@andresantosoficial.com.br</p>
              ...
              <div className="text-center mt-8 pt-6 border-t border-[#324d67]">
                <p className="text-white font-bold">André Santos</p>
