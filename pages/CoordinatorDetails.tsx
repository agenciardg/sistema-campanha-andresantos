...
import { coordenadoresService, liderancasService, cadastrosService, equipesService, Coordenador, Lideranca, Cadastro, Equipe, supabase } from '../lib/supabase';
...
const CoordinatorDetails: React.FC = () => {
  ...
  const carregarDados = async () => {
    ...
    try {
      setLoading(true);
      const [coordData, liderData, cadData, equipesData, ecData] = await Promise.all([
