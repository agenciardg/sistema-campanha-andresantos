...
const Coordinators: React.FC = () => {
  ...
  const handleEdit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: '', region: '', phone: '', email: '', goal: '', organization: '', cep: '', street: '', number: '', neighborhood: '', city: '' });
              ...
              <div className="flex flex-col gap-3">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {equipes.map((equipe: Equipe) => (
                        <option key={equipe.id} value={equipe.nome} className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">
                          {equipe.nome}
                        </option>
                      ))}
                    </select>
                ...
                <div className="flex gap-3 pt-2 border-t border-white/5 mt-2">
                  <button
                    ...
                    className="flex-1 px-5 py-3 dark:bg-white/[0.03] light:bg-gray-50 border dark:border-white/10 light:border-gray-300 rounded-xl dark:text-gray-300 light:text-gray-600 dark:hover:bg-white/[0.05] light:hover:bg-gray-100 dark:hover:text-white light:hover:text-gray-900 transition-all font-light"
                  >
                    Cancelar
                  </button>
                  <button
