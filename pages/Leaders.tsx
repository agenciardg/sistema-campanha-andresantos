...
const Leaders: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: '', team: '', phone: '', email: '', goal: '', organization: '', cep: '', street: '', number: '', neighborhood: '', city: '' });
    } catch (error) {
            ...
            <form onSubmit={handleSubmit} className="p-6 max-h-[70vh] overflow-y-auto">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Igreja Batista Central" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Igreja Batista Central</option>
                      <option value="Sindicato Metalúrgicos" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Sindicato Metalúrgicos</option>
                      <option value="Assoc. Bairro Norte" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Assoc. Bairro Norte</option>
                      <option value="Comunidade Vida Nova" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Comunidade Vida Nova</option>
                      <option value="Clube dos Lojistas" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Clube dos Lojistas</option>
                      <option value="Assoc. Pais e Mestres" className="bg-white dark:bg-[#1a1f2e] text-gray-900 dark:text-white">Assoc. Pais e Mestres</option>
                    </select>
                    <Icon name="expand_more" className="absolute right-3 top-1/2 -translate-y-1/2 text-[#1e5a8d] dark:text-gray-500 pointer-events-none text-[18px]" />
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-100 dark:border-white/5 mt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-5 py-3 bg-gradient-to-r from-[#1e3a5f] to-[#1e5a8d] hover:from-[#1e4976] hover:to-[#2563eb] text-white font-semibold rounded-xl transition-all shadow-lg shadow-[#1e3a5f]/25 hover:shadow-[#1e5a8d]/40 hover:scale-[1.02] flex items-center justify-center gap-2"
                  >
