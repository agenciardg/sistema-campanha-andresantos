                ...
                <div className="relative z-10 w-full max-w-[480px] flex flex-col gap-6 rounded-xl bg-[#1a2632] shadow-2xl border border-[#324d67] p-8 md:p-10">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex flex-col items-center justify-center text-center">
                            <h1 className="text-2xl font-bold tracking-tight dark:text-white light:text-gray-900">Vote Manager</h1>
                            <p className="text-[#92adc9] text-sm mt-2">Acesso seguro para coordenadores e equipe</p>
                        </div>
                    </div>
