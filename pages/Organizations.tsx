            ...
            <form onSubmit={handleSubmit} className="p-6 max-h-[70vh] overflow-y-auto">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3 pt-2 border-t border-white/5 mt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-5 py-3 bg-gradient-to-r from-[#1e3a5f] to-[#1e5a8d] hover:from-[#1e4976] hover:to-[#2563eb] dark:text-white light:text-gray-900 font-medium rounded-xl transition-all shadow-lg shadow-[#1e3a5f]/25 hover:shadow-[#1e5a8d]/40 hover:scale-[1.02] flex items-center justify-center gap-2"
                  >
                    <Icon name="check" className="text-[18px]" />
                    Criar Organização
                  </button>
