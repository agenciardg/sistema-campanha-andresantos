...
-- 2. Habilitar RLS
ALTER TABLE pltdataandrebueno_equipe_coordenadores ENABLE ROW LEVEL SECURITY;
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'pltdataandrebueno_equipe_coordenadores' 
        ...
        CREATE POLICY "Authenticated users can read equipe_coordenadores"
          ON pltdataandrebueno_equipe_coordenadores FOR SELECT
          TO authenticated
          USING (true);
    END IF;
    ...
    IF NOT EXISTS (
        ...
        CREATE POLICY "Superadmin can manage equipe_coordenadores"
          ON pltdataandrebueno_equipe_coordenadores FOR ALL
          TO authenticated
